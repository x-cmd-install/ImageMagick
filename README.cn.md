...
合计: **523,978** 行代码（覆盖前 5 种语言、共 **823** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| C | 362,794 | 106,484 | 26,886 | 286 |
| Html | 51,650 | 407 | 5,487 | 68 |
| Autoconf | 33,649 | 6,763 | 4,342 | 49 |
...
- **Star**: 17,389 · **Fork**: 1,653 · **开放 issue**: 3,573 · **贡献者**: 209

## 累计统计

- **发布数**: 281 · **已合并 PR**: 483 · **开放 PR**: 9 · **已关闭 issue**: 3419 · **开放 issue**: 154 · **提交数**: 24670
...
_数据快照: `data/card/260911.yml` · 2026-09-11T05:19:54Z._
